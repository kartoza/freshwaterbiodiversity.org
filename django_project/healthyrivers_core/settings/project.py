...
try:
    TEMPLATES[0]['DIRS'] = [
        absolute_path('healthyrivers_core', 'base_templates'),
        absolute_path('healthyrivers_base', 'templates'),
    ] + TEMPLATES[0]['DIRS']
...
STATICFILES_DIRS = [
    ...
    absolute_path('healthyrivers_core', 'base_static'),
    absolute_path('healthyrivers_base', 'static'),
] + STATICFILES_DIRS
